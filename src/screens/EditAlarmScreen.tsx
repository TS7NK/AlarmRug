    ...
    <Background>
      <SafeAreaView style={styles.container}>
        <View>
          <View style={styles.header}>
            <Pressable onPress={navigation.goBack} style={styles.backButton}>
              {({ pressed }) => (
                <AntDesign name="arrowleft" size={28} color={pressed ? Colors.black : Colors.balck} />
              )}
            </Pressable>
            <VivText fontName="Title6" color={Colors.black} style={{ marginLeft: -15 }}>
              Editing {alarm.hour}:{alarm.minute} {alarm.meridiem}
            </VivText>
            <Pressable onPress={navigation.goBack} style={{ opacity: 0 }}>
              {({ pressed }) => (
                <AntDesign name="arrowleft" size={28} color={pressed ? Colors.black : Colors.black} />
              )}
            </Pressable>
          </View>
        </View>
        ...
        <View style={styles.timeLeft}>
          <VivText fontName="Body" color={Colors.black}>
            Time left ~
          </VivText>
          <VivText fontName="Body" color={Colors.black}>
