...
export default function ActiveAlarms({ nearestAlarm }: ActiveAlarmsProps) {
  return (
    <View style={styles.container}>
      <VivText fontName={resize<FontName>('Title4', 'Title6', 'Title2')} color={Colors.black}>
        Next alarm at...
      </VivText>
      <View style={styles.time}>
        <VivText fontName={resize<FontName>('Title1', 'Title3', 'TitleBig1')} color={Colors.black}>
          {nearestAlarm.hour} : {nearestAlarm.minute}{' '}
          <VivText fontName={resize<FontName>('Title2', 'Title4', 'TitleBig2')} color={Colors.black}>
