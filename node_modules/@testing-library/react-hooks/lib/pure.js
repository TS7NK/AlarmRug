...
function renderHook(callback, _temp) {
  ...
  var wrapUiIfNeeded = function wrapUiIfNeeded(innerElement) {
    return wrapper ? /*#__PURE__*/_react["default"].createElement(wrapper, hookProps.current, innerElement) : innerElement;
  };

  var toRender = function toRender() {
    return wrapUiIfNeeded( /*#__PURE__*/_react["default"].createElement(_react.Suspense, {
